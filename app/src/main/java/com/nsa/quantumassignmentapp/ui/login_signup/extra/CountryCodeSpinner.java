...
public class CountryCodeSpinner extends AppCompatSpinner {
    ...
    public CountryCodeSpinner(Context context, AttributeSet attrs) {
       ...
       // countryCodeAdapter = new CountryCodeAdapter(context, R.layout.spinner_layout, arrayList);
    ...
    public class CountryCodeAdapter extends ArrayAdapter<CountryModel> {
        ...
        public CountryCodeAdapter(@NonNull Context context, List<CountryModel> arrayList) {
        ...
        public CountryCodeAdapter(@NonNull Context context, @LayoutRes int resource, List<CountryModel> arrayList) {
        ...
        public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            return createItemView(position,true);
        }

        @Override
        public @NonNull
        View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            return createItemView(position,false);
        }

        private View createItemView(int position, boolean isDropDown) {
...
//                tvCountry.setText(model.getPhoneCode());
      //      }
